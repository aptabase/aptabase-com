...
Overall, I'm very happy with my decision to use Tauri. I'm not saying it's always better than Electron, but if it has the features you need, I'd say give it a try! As mentioned before, you might not even need to write that much code in Rust, so don't get intimidated by that! You'll be surprised by how much you can do with just JavaScript.
...
I'm also working on a [open source and privacy-friendly analytics platform](https://aptabase.com) for dekstop and mobile apps. We have SDKs for various different frameworks, including Tauri and Electron. Fun fact: The Tauri SDK is packaged as a Tauri Plugin! 😄

Lastly, I'm also very active on [Twitter](https://twitter.com/goenning). Feel free to reach out if you have any questions or feedback, I love talking about Tauri!
